...
type Greeting struct {
	...
	Vaccinetype string `protobuf:"bytes,5,opt,name=vaccinetype,proto3" json:"vaccinetype,omitempty"`
...
func (x *Greeting) GetGender() string {
	if x != nil {
		return x.Gender
	}
	return ""
...
func (x *Greeting) GetVaccinetype() string {
	if x != nil {
...
var file_greet_proto_rawDesc = []byte{
	...
	0x18, 0x03, 0x20, 0x01, 0x28, 0x03, 0x52, 0x03, 0x61, 0x67, 0x65, 0x12, 0x20, 0x0a, 0x0b, 0x76,
	0x61, 0x63, 0x63, 0x69, 0x6e, 0x65, 0x74, 0x79, 0x70, 0x65, 0x18, 0x05, 0x20, 0x01, 0x28, 0x09,
	0x52, 0x0b, 0x76, 0x61, 0x63, 0x63, 0x69, 0x6e, 0x65, 0x74, 0x79, 0x70, 0x65, 0x12, 0x12, 0x0a,
